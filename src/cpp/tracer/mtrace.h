#ifndef NPC_TRACER_MTRACE_H_
#define NPC_TRACER_MTRACE_H_
...
struct MTraceEntry {
  ...
  MTraceEntry() = default;
  MTraceEntry(uint64_t pc, MemDir dir, uint64_t addr, uint64_t data,
  ...
  friend std::ostream& operator<<(std::ostream& os, const MTraceEntry& e) {
