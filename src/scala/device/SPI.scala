...
/** Generic SPI Controller (APB slave)
  *
  * This is a pure SPI controller without any device-specific knowledge. It
  * wraps the spi_top_apb BlackBox and provides:
  ...
  * APBArbiter to arbitrate between multiple masters before connecting to this
  * node.
  */
...
/** Convenience class for SPI Flash XIP (backward compatibility) Uses the
  * generic APBXIPController from amba package with SPIFlash config.
  */
